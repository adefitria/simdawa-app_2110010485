                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="nama_beasiswa" value="<?= $beasiswa->nama_beasiswa ?>"
                                        placeholder="Nama Beasiswa" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tanggal_mulai" class="col-md-2">Tanggal Mulai</label>
                                <div class="col-md-10">
                                    <input type="date" name="tanggal_mulai" value="<?= $beasiswa->tanggal_mulai ?>"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="date" name="tanggal_selesai" value="<?= $beasiswa->tanggal_selesai ?>"
                                        required class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
