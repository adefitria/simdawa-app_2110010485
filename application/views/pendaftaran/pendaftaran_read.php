                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('pendaftaran') ?>"
                                        class="breadcrumb-link">Pendaftaran Akun</a></li>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('pendaftaran/daftar') ?>" class="btn btn-sm btn-success float-right"><i
                                class="fas fa-plus">Tambah Data</i></a>
                        <a href="<?= base_url('pendaftaran/cetak') ?>" class="btn btn-sm btn-info mr-1 float-right"><i
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									if ($a->keterangan == 'Belum Diverifikasi') :
										echo "<td>
										<a href=" . base_url('pendaftaran/verifikasi/acc/' . $a->id) . " class='btn btn-info btn-sm'><i class='fa fa-check'></i> Konfirmasi</a>
										<a href=" . base_url('pendaftaran/verifikasi/batal/' . $a->id) . " class='btn btn-danger btn-sm' onclick='return confirm(\"Ingin batalkan akun ini?\")'><i class='fa fa-ban'></i> Batalkan</a>
										</td>";
									else :
