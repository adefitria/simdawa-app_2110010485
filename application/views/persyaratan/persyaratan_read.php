                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('persyaratan') ?>"
                                        class="breadcrumb-link">Persyaratan</a></li>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?= base_url('persyaratan/tambah') ?>" class="btn btn-sm btn-success float-right"><i
                                class="fas fa-plus">Tambah Data</i></a>
                        <a href="<?= base_url('persyaratan/cetak') ?>" target="_blank"
                        ...
                        <table class="table table-bordered" id="mytabel">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $a->keterangan ?></td>
                                    <td>
                                        <a href="<?= base_url('persyaratan/ubah/' . $a->id) ?>"
                                            class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Ubah</a>
                                        <a href="<?= base_url('persyaratan/hapus/' . $a->id) ?>"
