                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-2" aria-controls="submenu-2"><i class="fas fa-database"></i>Master
                            Data</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-archive"></i>Pengajuan
                            Beasiswa</a>
                        <div id="submenu-3" class="collapse submenu">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= base_url('pengajuan/diusulkan') ?>">Pengajuan
                                        Diusulkan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= base_url('pengajuan/ditetapkan') ?>">Pengajuan
                                        Ditetapkan</a>
                                </li>
                            </ul>
                        </div>
